      ...
      >
        ...
        <div style={{ padding: '1.5rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '1.8rem', color: '#ff6b35', fontWeight: 'bold', margin: '0 0 1rem 0' }}>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                <ul style={{ margin: 0, paddingLeft: '1.5rem' }}>
                  {Object.entries(product.specs).map(([key, value]) => (
                    <li key={key} style={{ margin: '0.25rem 0', fontSize: '0.9rem', color: '#666' }}>
